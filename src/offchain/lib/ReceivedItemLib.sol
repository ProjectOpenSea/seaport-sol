...
import { ReceivedItem, ConsiderationItem } from "seaport/lib/ConsiderationStructs.sol";
...
library ReceivedItemLib {
     ...
     * @param defaultName the name of the default for retrieval
     */
    function saveDefault(ReceivedItem memory receivedItem, string memory defaultName) internal {
        mapping(string => ReceivedItem) storage receivedItemMap = _receivedItemMap();
