...
library SeaportArray {
    ...
    function OrderComponentss(OrderComponents memory a) internal pure returns (OrderComponents[] memory) {
        OrderComponents[] memory arr = new OrderComponents[](1);
        arr[0] = a;
        return arr;
    }

    function OrderComponentss(
    ...
    function OrderParameterss(OrderParameters memory a) internal pure returns (OrderParameters[] memory) {
        OrderParameters[] memory arr = new OrderParameters[](1);
        arr[0] = a;
        return arr;
    }

    function OrderParameterss(
    ...
    function BasicOrderParameterss(BasicOrderParameters memory a)
        internal
        pure
    ...
    function BasicOrderParameterss(
